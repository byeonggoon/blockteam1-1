...
#if defined(NDEBUG)
# error "Hashroot cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Hashroot Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s STW additional fees, %d delta bytes\n",
