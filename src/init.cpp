...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hashroot-project/hashroot>";
    const std::string URL_WEBSITE = "<https://hashroot.org>";
