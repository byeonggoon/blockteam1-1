...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s hashroot-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hashroot-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hashroot transaction") + "\n" +
              "  hashroot-tx [options] -create [commands]   " + _("Create hex-encoded hashroot transaction") + "\n" +
              "\n";
