...
{
    const char* pszTimestamp = "We are stellar forest team since 21.07.01";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1625123710, 1736144, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x189b4f4ee463e7df3e18ef86c5edbdd46bc6c7a7a6049e480b3dec8a9fc4f2e7"));
        assert(genesis.hashMerkleRoot == uint256S("0xeb33117b8f0fd8a5d4a5f9dc35e61979bc7cf8daa1767f2d669e61c833714575"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.hashroot.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        // vSeeds.emplace_back("dnsseed.hashroottools.com", true);
        // vSeeds.emplace_back("dnsseed.hashrootpool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {     0, uint256S("0x189b4f4ee463e7df3e18ef86c5edbdd46bc6c7a7a6049e480b3dec8a9fc4f2e7")}
        ...
        chainTxData = ChainTxData{
            ...
            1625123710, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1625124968, 468641, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2bca3760dfdd1ded249c9d2b2e3644a9370efa00e9d7f170d3c35631ba264f46"));
        assert(genesis.hashMerkleRoot == uint256S("0xeb33117b8f0fd8a5d4a5f9dc35e61979bc7cf8daa1767f2d669e61c833714575"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.hashroottools.com", true);
        vSeeds.emplace_back("seed-b.hashroot.loshan.co.uk", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("2bca3760dfdd1ded249c9d2b2e3644a9370efa00e9d7f170d3c35631ba264f46")},
            }
        };
