...
const char * const BITCOIN_CONF_FILENAME = "hashroot.conf";
const char * const BITCOIN_PID_FILENAME = "hashroot.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Hashroot";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Hashroot";
#else
    // Unix
    return pathRet / ".hashroot";
#endif
#endif
}
